  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link href="/queue" className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 hover:shadow-md transition-shadow">
        ...
        <div className="space-y-2">
          ...
          {dashboardData?.currentQueue && dashboardData.currentQueue.length > 5 && (
            <div className="text-center py-2">
              <Link href="/queue" className="text-blue-500 hover:underline text-sm">
